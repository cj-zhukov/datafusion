...
use datafusion::logical_expr::statistics::{ColumnStatistics, ProbabilityDistribution};
...
fn boundary_analysis_and_selectivity_demo() -> Result<()> {
    ...
    let column_stats = ColumnStatistics {
        null_count: ProbabilityDistribution::new_exact(ScalarValue::Int64(Some(0)))?,
        max_value: ProbabilityDistribution::new_exact(ScalarValue::Int64(Some(10000)))?,
        min_value: ProbabilityDistribution::new_exact(ScalarValue::Int64(Some(1)))?,
        sum_value: ProbabilityDistribution::new_unknown(&DataType::Int64)?,
        distinct_count: ProbabilityDistribution::new_unknown(&DataType::Int64)?,
    };
...
fn boundary_analysis_in_conjuctions_demo() -> Result<()> {
    ...
    let column_stats = ColumnStatistics {
        null_count: ProbabilityDistribution::new_exact(ScalarValue::Int64(Some(0)))?,
        max_value: ProbabilityDistribution::new_exact(ScalarValue::Int64(Some(79)))?,
        min_value: ProbabilityDistribution::new_exact(ScalarValue::Int64(Some(14)))?,
        sum_value: ProbabilityDistribution::new_unknown(&DataType::Int64)?,
        distinct_count: ProbabilityDistribution::new_unknown(&DataType::Int64)?,
    };
